                ...
                <div ref={ref} className="wrapper mx-auto px-4">
                    ...
                    <div className="pl-4 sm:pl-8 md:pl-12">
                        ...
                        <div className="w-full max-w-[500px]">
                                <input 
                                    className="mb-3 w-full bg-transparent focus:bg-blue-100 placeholder:text-blue-400 texts-xl text-blue-700 outline-0 border-black border-b-2 p-3 focus:border-blue-700 transition-all" 
                                    type="text" 
                                    placeholder='Subject'                
                                ...
                                <textarea 
                                    className="mb-3 w-full bg-transparent focus:bg-blue-100 placeholder:text-blue-400 texts-xl text-blue-700 outline-0 border-black border-b-2 p-3 focus:border-blue-700 resize-y transition-all" 
                                ...
                                <div className='flex'>
                                    <a
                                        ...
                                        className="mt-4 px-3 py-2 flex items-center text-blue-700 border-t-2 border-b-2 border-black hover:border-blue-700 hover:bg-blue-700 hover:text-white hover:-translate-y-1 transition-all"
                                    >
